...
START_TEST(s21_sscanf_test) {
  ...
  ck_assert_int_eq(s21_sscanf("2", "%p", &bibka), sscanf("2", "%p", &pipka));
...
START_TEST(s21_sprintf_test) {
  ...
  ck_assert_int_eq(s21_sprintf(r, "%.4e", st_e), sprintf(r, "%.4e", st_e));
  ck_assert_int_eq(s21_sprintf(r, "%16.5e", st_e), sprintf(r, "%16.5e", st_e));
  ck_assert_int_eq(s21_sprintf(r, "%+16.5e", st_e),
                   sprintf(r, "%+16.5e", st_e));
  ck_assert_int_eq(s21_sprintf(r, "%-16.5e", st_e),
                   sprintf(r, "%-16.5e", st_e));
  ck_assert_int_eq(s21_sprintf(r, "%016.5e", st_e),
  ...
  ck_assert_int_eq(s21_sprintf(r, "%g", st_g), sprintf(r, "%g", st_g));
  ck_assert_int_eq(s21_sprintf(r, "%16.5g", st_g), sprintf(r, "%16.5g", st_g));
  ck_assert_int_eq(s21_sprintf(r, "%+16.5g", st_g),
                   sprintf(r, "%+16.5g", st_g));
  ck_assert_int_eq(s21_sprintf(r, "%-16.5g", st_g),
                   sprintf(r, "%-16.5g", st_g));
  ck_assert_int_eq(s21_sprintf(r, "%016.5g", st_g),
  ...
  ck_assert_int_eq(s21_sprintf(r, "%o", st_o), sprintf(r, "%o", st_o));
  ck_assert_int_eq(s21_sprintf(r, "%16.5o", st_o), sprintf(r, "%16.5o", st_o));
  ck_assert_int_eq(s21_sprintf(r, "%+16.5o", st_o),
                   sprintf(r, "%+16.5o", st_o));
  ck_assert_int_eq(s21_sprintf(r, "%-16.5o", st_o),
                   sprintf(r, "%-16.5o", st_o));
  ck_assert_int_eq(s21_sprintf(r, "%016.5o", st_o),
  ...
  ck_assert_int_eq(s21_sprintf(r, "%-16.5x", st_x),
                   sprintf(r, "%-16.5x", st_x));
  ck_assert_int_eq(s21_sprintf(r, "%016.5x", st_x),
...
Suite *Suite_create(void) {
  ...
  tcase_add_test(tcase_test, s21_sscanf_test);
